...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapSplashscreenThree(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapVerificationscreen(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapReferralContainer(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapSplashscreenThree(BuildContext context) {
  ...
  onTapVerificationscreen(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.verificationScreen);
  }

  onTapReferralContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.referralContainerScreen);
  }

  onTapVehiclestatus(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.vehicleStatusScreen);
  }
